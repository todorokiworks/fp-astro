...
(function (root, factory) {
  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    preloader.onload = function () {
      ...
      windowWidth = $('tp-border').innerWidth();
      windowHeight = $('tp-border').innerHeight();
  ...
  Lightbox.prototype.sizeOverlay = function () {
    ...
    */
    setTimeout(function () {
      self.$overlay
        .width($('.tp-border').innerWidth())
        .height($('.tp-border').innerHeight());
